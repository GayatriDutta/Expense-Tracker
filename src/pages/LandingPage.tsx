...
const LandingPage: React.FC = ({}) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-green-900 relative overflow-hidden">
      ...
      {/* Header */}
      <header className="z-50 w-full fixed top-0 left-0 bg-gradient-to-r from-blue-400 to-green-500 flex flex-wrap items-center justify-between gap-4 p-4 sm:p-6 lg:px-12">
        {/* Logo Section */}
        ...
        <div className="ml-auto sm:ml-0">
          <button
            ...
            className="bg-blue-500 text-white px-6 py-2 rounded-full font-medium hover:from-blue-700 transition-all duration-300 shadow-lg hover:shadow-xl"
          >
            Sign In
          </button>
        </div>
      ...
      {/* Main Content */}
      <main className="relative z-10 max-w-7xl m-10 px-4 sm:px-6 lg:px-12 pt-12 lg:pt-20">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <span className="text-gray-300 ml-2">
                    Track expenses, set budgets, analyze spending patterns, and
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <span className="text-gray-300 ml-2">
                    Get insights with beautiful charts, category breakdowns, and
                    spending trends.
                  </span>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <span className="text-gray-300 ml-2">
                    Set monthly budgets, track progress, and get alerts when
                    you're overspending.
                  </span>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                {[
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div
                        className={`w-2 h-2 ${transaction.color} rounded-full`}
                      ></div>
                      <div>
        ...
        <div className="mt-24 mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="text-center group">
              ...
              <p className="text-gray-300">
                Add expenses in seconds with our intuitive interface and smart
                categorization.
              </p>
            </div>
          </div>
      ...
      {isModalOpen && (
        <AuthForm onClose={() => setIsModalOpen(false)} mode={"login"} />
      )}
    </div>
  );
};
